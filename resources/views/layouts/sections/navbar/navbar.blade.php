        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="{{ $user_data->is_active ? "avatar avatar-online" :"avatar avatar-offline" }}">
            ...
            <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                ...
                <a class="dropdown-item pb-2 mb-1" href="javascript:void(0);">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                      <h6 class="mb-0">{{ $user_data->username}}</h6>
                      <small class="text-muted">{{  $role }} </small>
                      <small  class="{{ $user_data->is_active ? "text-success" :"text-danger" }}">{{  $user_data->is_active ? "online":"offline"  }}</small>
                    </div>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a class="dropdown-item" href="javascript:void(0);" onclick="handleLogout(this,1)">
