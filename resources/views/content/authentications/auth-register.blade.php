    ...
    <div class="authentication-inner py-4">
      ...
      <div class="card p-2">
        ...
        <div class="card-body mt-2">
          ...
          <form id="frm-register" class="mb-3" >
            ...
            <button class="btn btn-primary d-grid w-100 btn-register" type="button" disabled>
              Sign up
            </button>
          </form>
...
<script src="{{ asset('assets/js-external/register.js') }}"></script>
