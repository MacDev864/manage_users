...
(function ($) {
    ...
    $(document).on('click', '.remove-navigation-toggler', function () {
        body_.removeClass();
        $('.remove-navigation-toggler').removeClass('d-block').addClass('d-none');
    });
    $(document).on('click', '.navigation-toggler a', function () {
        if (wind_.width() < 1200) {
            ...
            if (!body_.hasClass('navigation-toggle-one') && !body_.hasClass('navigation-toggle-two')) {
                ...
                $('.remove-navigation-toggler').removeClass('d-none').addClass('d-block');
