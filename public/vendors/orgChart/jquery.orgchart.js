(function($) {
    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            switch (this.data.id) {
                case 1:
                    let com_img = APP_BASE_URL + "/company/"+this.data.sys_customer_code+"/images/"+this.data.company_img;                    
                    this.data.have_img ? img = `<img id="img" src="${com_img}">` : img = ``;
                    this.data.name_en != null || this.data.name_en != "" ? name_en = `<div>${this.data.name_en}</div>` : name_en = ``;
                    status_node = "parent";
                    break;
                default:
                    status_node = "child";
            ...
            switch (this.data.level) {
                case 2:
                    bg_level = "bg-department";
                    break;
                case 3:
                    bg_level = "bg-section";
                    break;
                case 4:
                    bg_level = "bg-position";
                    break;
                default:
                    bg_level = "bg-master";
                    break;
            ...
            return "<div class='node "+status_node+' '+bg_level+"' node-id='"+this.data.id+"'>"+img+nameString+name_en+descString+buttonsHtml+"</div>";
        }
    }
